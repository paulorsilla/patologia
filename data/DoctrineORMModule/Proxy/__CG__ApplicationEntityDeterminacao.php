 ...
 */
class Determinacao extends \Application\Entity\Determinacao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Determinacao' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Determinacao' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Determinacao' . "\0" . 'tipo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Determinacao $proxy) {
