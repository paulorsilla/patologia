 ...
 */
class Especie extends \Application\Entity\Especie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Especie' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Especie' . "\0" . 'descricao'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Especie $proxy) {
